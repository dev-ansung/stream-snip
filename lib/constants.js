...
const MSG_TYPES = {
  ...
  TAB_MEDIA_SEEK: 'TAB_MEDIA_SEEK',
  GET_PAGE_MEDIA_TIME: 'GET_PAGE_MEDIA_TIME',
  STREAM_DETECTED: 'STREAM_DETECTED',
  ENABLE_TAB_SEEK_SYNC: 'ENABLE_TAB_SEEK_SYNC',
  DISABLE_TAB_SEEK_SYNC: 'DISABLE_TAB_SEEK_SYNC'
};
